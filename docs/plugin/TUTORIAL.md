...
```powershell
harness --help
# deve listar 25 subcomandos: compile, audit, audit-runtime, analyze,
#   preflight, compile-contract, task, profile, compile-session, verify,
#   decide, lesson, blind, team, review, supervise, budget, reconcile,
#   audit-team, finish, disable, enable, status, doctor, pr-draft
```
