...
Gerado por `tests/e2e/test_fase3_outcomes.py` (repos sintéticos em tmp_path via subprocess da CLI real + hooks standalone gerados + funções públicas de módulo).
