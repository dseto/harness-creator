...
```
python.exe -m harness.cli preflight --dir C:\Users\danie\AppData\Local\Temp\pytest-of-danie\pytest-468\test_preflight_e2e_dogfood0\mock_a_cru
```
...
{
  "verdict": "NOT_READY",
  "target": "C:\\Users\\danie\\AppData\\Local\\Temp\\pytest-of-danie\\pytest-468\\test_preflight_e2e_dogfood0\\mock_a_cru",
  "categories": [
    {
      "id": "git",
...
```
python.exe -m harness.cli preflight --dir C:\Users\danie\AppData\Local\Temp\pytest-of-danie\pytest-468\test_preflight_e2e_dogfood0\mock_b_completo
```
...
{
  "verdict": "READY",
  "target": "C:\\Users\\danie\\AppData\\Local\\Temp\\pytest-of-danie\\pytest-468\\test_preflight_e2e_dogfood0\\mock_b_completo",
  "categories": [
    {
      "id": "git",
      "title": "Controle de Versão (Git)",
